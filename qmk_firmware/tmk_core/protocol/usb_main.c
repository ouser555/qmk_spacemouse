...
//#if 1
#ifdef SPACEMOUSE
void send_3dmouse1(report_3dmouse1_t *report) {

    send_report(USB_ENDPOINT_IN_SHARED, report, sizeof(report_3dmouse1_t));

}

void send_3dmouse2(report_3dmouse2_t *report) {

    send_report(USB_ENDPOINT_IN_SHARED, report, sizeof(report_3dmouse2_t));
